...
namespace MiniMAL
{
    public class Anime : Entry<TypeAnime, AiringStatus, WatchingStatus>
    {
        ...
        public void LoadFromXmlNode(XmlNode e)
        {
            ...
            Type = MiniMALConverter.XmlToString(e["series_type"]) != "" ? (TypeAnime)Int32.Parse(MiniMALConverter.XmlToString(e["series_type"])) : TypeAnime.None;
            Episodes = MiniMALConverter.XmlToInt(e["series_episodes"]);
            Status = MiniMALConverter.XmlToString(e["series_status"]) != "" ? (AiringStatus)Int32.Parse(MiniMALConverter.XmlToString(e["series_status"])) : AiringStatus.None;
            ...
            MyStatus = MiniMALConverter.XmlToString(e["my_status"]) != "" ? (WatchingStatus)Int32.Parse(MiniMALConverter.XmlToString(e["my_status"])) : WatchingStatus.None;
